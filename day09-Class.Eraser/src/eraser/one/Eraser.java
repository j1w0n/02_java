 ...
 * 한 겹씩 제거 : peel() : void : 현재 layer 값에서 1 감소 layer 가 0이 될 때까지
 * 지우개 상태 출력 : print() : void - 현재 지우개의 가로, 세로, 높이, 남은 겹, 색상 등의 상태를 출력
 * 
...
public class Eraser {
	...
	// (3)   
	 public void print() {
		 System.out.printf("가로:%4.2f, 세로:%4.2f, 높이:%4.2f, 남은 겹:%d, 색상:%s", width, height, depth, layer, color);
	 }
