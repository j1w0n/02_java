...
/**
 * 서점에서 할 수 있는 여러 기능등
 * 책찾기, 책수정, 신간추가, 책 폐기 등의 기능을 테스트하는 클래스
 * 
...
public class BookStoreTest {
	...
	public static void main(String[] args) {
        ...
        Book dduk =
        		new Book(4, "9791196394509", "죽고 싶지만 떡볶이는 먹고싶어", "백세희", "혼", 208, 12420, 2);
        Book ax =
              new Book(5, "9788956055466", "책은 도끼다", "박웅현", "북하우스", 348, 144400, 2);
      ...
      // 2. 서점에 도착한 신간 입고
       ...
       System.out.println(" 3. ===== 신간 확인 ====");
        Book [] allBooks = kyobo.gerAllBooks();
        ...
        // 4. 채식주의자 가격할인 : set
         ...
         Book vegetarian2 = 
        		 new Book(1,"9788936433598", "채식주의자", "한강", "창비",247 ,10000, 10);
         ...
         System.out.println(" 7. ===== 책은 도끼다 삭제 후 전체 목록 확인====");
        	for (Book book: kyobo.gerAllBooks())  {
